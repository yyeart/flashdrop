...
var (
	...
	ErrNilReservationService   = errors.New("reservation service must not be nil")
	ErrInvalidDuration         = errors.New("invalid duration")
	ErrNilOrderService         = errors.New("order service must not be nil")
	ErrMultipleIdempotencyKeys = errors.New("request header contains multiple idempotency keys")
